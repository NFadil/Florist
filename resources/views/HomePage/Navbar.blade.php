     ...
     <nav class="navbar navbar-expand-md navbar-light container">
         ...
         <div class="collapse navbar-collapse" id="navbarNav">
             ...
             <div class="d-flex align-items-center gap-3">
                 <button class="btn text-dark px-4 py-2 rounded-pill" style="background-color:#ffc7bd">Masuk</button>
                 <a href="#" class="text-dark"><i data-lucide="shopping-cart" class="shake-on-hover"></i></a>
             </div>
         </div>
     </nav>
 </header>
